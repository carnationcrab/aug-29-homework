...
The function will return true if the email is valid and false if it's not.
Super simple.
...
but this challenge will satisfy 95% of use cases. 
If you're unsure of something, check out the lab tests to understand exactly 
what's being evaluated. 
*/

function validateEmail(str) {
    if (str.includes("@") && str.includes(".") && (str.lastIndexOf("@") > (str.length - (str.length - 1))) && str.indexOf("@") < str.lastIndexOf(".")) {
      return true
    }
    else {
      return false
